        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-2 items-center">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="pt-4 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
              <button
                ...
                className="relative group px-8 py-4 overflow-hidden rounded-lg font-bold text-sm uppercase tracking-wider transition-all duration-300 hover:scale-105"
              >
                {/* Background gradient */}
                <div className="absolute inset-0 bg-gradient-to-r from-clay via-clay to-clay/80"></div>
                ...
                {/* Content */}
                <span className="relative flex items-center gap-3 justify-center text-white">
                  Find Out More
          ...
          <div className="flex flex-col items-center animate-slideInRight opacity-0 lg:opacity-100 lg:flex lg:animate-slideInRight" style={{ animationDelay: '0.4s', animation: 'slideInRight 0.8s ease-out 0.4s forwards' }}>
            <div className="relative group">
              ...
              {/* Animated floating arrow with label - Hidden on mobile */}
